                ...
                <div class="container-fluid profile-section p-0">
                    ...
                    <div class="row p-0 m-0">
                        <div class="col-lg-12 justify-content-center align-items-center p-0">
                            <?php if(auth()->user()==null||auth()->user()->caravan==null||$caravan->id!=auth()->user()->caravan->id): ?>
                            <a href="#" class="modif-prof-bd caravan-contact p-2"><i class="fas fa-paper-plane"></i></a>
                            <?php else: ?>
                            <a href="/caravan/<?php echo e($caravan->id); ?>/edit" class="modif-prof-bd p-2">Modifier le Profile</a>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Desktop\BloodDonation-master\resources\views/caravans/caravan.blade.php ENDPATH**/ ?>
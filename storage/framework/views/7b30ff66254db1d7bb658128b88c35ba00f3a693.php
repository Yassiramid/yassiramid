  ...
  width: 19%;
                ...
                <div class="container-fluid">
                   <div class="container-fluid row">
                    ...
                    je suis un homme  diplomé de L'Office de la formation professionnelle et de Travail (OFPPT), j'ai realiser cette platforme comme mon projet de fin de formation sous l'encadrage de Mme abdelaali Jeghboub .
                    </p> 
                   </div>
                                ...
                                <div class="we-cards">
                                    <div class="container-fluid row">
                                      <div class="col-md-4 pl-5 p-3">
                                        <img class="mt-4 rounded-circle we-photo" src="/img/img.png" />
                                      </div>
                                        <div class="card-body col-md-8">
                                            <h4 class="we-names">Yassir Amid</h4>  
                                            <p class="card-text text-justify ">Est un développeur web diplômé de L'Office de la formation professionnelle et de Travail (OFPPT), passioné par la programation et  les nouvelles technologies et le designe graphique. <br>
                                            <strong>Outils: Php(LARAVEL), JavaScript, ReactJs, Javascript, Css, Bootstrap ... </strong>
                                            </p>
                                        </div>
                                    </div>
                                        <div class="card-body d-flex justify-content-around">
                                            <a href="" class="fa fa-linkedin"></a>
                                            <a href="https://github.com/YassirAmid/" class="fa fa-github"></a>
                                            <a href="https://twitter.com/YassirZahir" class="fa fa-twitter"></a>
                                            <a href="mailto:Yassiramid1@gmail.com" class="fa fa-google"></a>
                                            <a href="https://www.instagram.com/Yassir_zahir/" class="fa fa-instagram"></a>
                                       </div>
                                </div>
                            </div>
...
<?php /**PATH C:\Users\dell\Desktop\BloodDonation-master\resources\views/weare.blade.php ENDPATH**/ ?>
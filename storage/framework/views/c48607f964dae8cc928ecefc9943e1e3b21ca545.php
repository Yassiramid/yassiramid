    ...
    <div class="container mt-4 mb-5 contBack">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-6 bodyreg text-center order-sm-2 order-lg-2">
                ...
                <div class="conMsg">
                    <span class="deja ">Vous avez déjà un compte?</span><br> <a href="<?php echo e(route('login')); ?>"
            ...
            <div class="col-sm-12 col-md-6 col-lg-6 bodyreg justify-content-center text-center order-sm-1 order-lg-1">
                <form method="POST" action="<?php echo e(route('register')); ?>" onsubmit="return validat(this);">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus placeholder="Nom & Prenom">
...
unset($__errorArgs, $__bag); ?>" name="password" required autocomplete="new-password" placeholder="Mot De Pass">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Desktop\BloodDonation-master\resources\views/auth/register.blade.php ENDPATH**/ ?>